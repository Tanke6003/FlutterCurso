...
class _ActorsListView extends ConsumerWidget {
  ...
  final String  movieId;
  const _ActorsListView({ required this.movieId});
      ...
      children: [
        ...
        child:  Row(
          ...
          children: [
            ...
            //Description
            _MovieDescription(size: size, movie: movie, textStyles: textStyles),
  ...
  Widget build(BuildContext context) {
    ...
    return SliverAppBar(
      ...
      flexibleSpace: FlexibleSpaceBar(
        ...
        // style: const TextStyle( fontSize: 20,color: Colors.white),textAlign: TextAlign.start,
        // ),
        //centerTitle: false,
        background:Stack(
          children: [
